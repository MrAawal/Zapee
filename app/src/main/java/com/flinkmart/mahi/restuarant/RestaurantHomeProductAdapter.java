...
public class RestaurantHomeProductAdapter extends RecyclerView.Adapter<RestaurantHomeProductAdapter.holder>{
    ...
    public RestaurantHomeProductAdapter(Context context, List<Item> modelList) {
        this.context = context;
        this.modelList = modelList;
        this.productItems = modelList;
    }
    ...
    @NonNull
    @Override
    public RestaurantHomeProductAdapter.holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
       View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.newitem_product, parent , false);
       return  new holder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull RestaurantHomeProductAdapter.holder holder, int position) {
    ...
    public Filter getFilter() {
        return new Filter(){
            ...
            protected void publishResults(CharSequence constraint, FilterResults results) {
                productItems = (ArrayList<Item>) results.values ;
                notifyDataSetChanged();
            }
        };
    }
    ...
    private void bottomSheet(Item newProductModel, List<Item> productItems, int position, TextView remove, TextView cart){
        ...
        quantityDialogBinding.sizeItem.setBackgroundColor (context.getResources ().getColor (R.color.white));
