...
//
                            FirebaseFirestore.getInstance ().collection ("userRestaurant").document (uid).get( ).addOnCompleteListener (new OnCompleteListener<DocumentSnapshot> ( ) {
                                @Override
                                public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                                    if (task.isSuccessful ( )) {
                                                    ...
                                                    public void onMapReady(GoogleMap googleMap) {
                                                        ...
                                                        if(sp.contains("latitude")){
                                                           ...
                                                           String userlon = sp.getString ("longitude", "");
                                                            ...
                                                            LatLng user=new LatLng(Double.parseDouble (userlat),Double.parseDouble (userlon));
