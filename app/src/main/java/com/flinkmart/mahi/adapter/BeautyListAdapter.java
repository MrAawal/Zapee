...
public class BeautyListAdapter extends RecyclerView.Adapter<BeautyListAdapter.holder>{
    Context context;
    List<Item> productItems;

    public BeautyListAdapter(Context context, List<Item> productItems) {
    ...
    @NonNull
    @Override
    public BeautyListAdapter.holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
       View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.newitem_product, parent , false);
       return  new holder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull BeautyListAdapter.holder holder, int position) {
