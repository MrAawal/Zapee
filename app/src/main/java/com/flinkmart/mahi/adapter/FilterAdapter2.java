...
//            quantity.setText ("Item Added in cart");
                ...
                if(products.size ()>0){
                    quantity.setText (String.valueOf (products.size ()+1+" PRODUCTS ADDED"));
                }else {
                    quantity.setText (String.valueOf (products.size ()+1+" PRODUCT ADDED"));
                }
