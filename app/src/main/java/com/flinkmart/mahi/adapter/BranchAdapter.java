        ...
        holder.itemView.setOnClickListener (new View.OnClickListener ( ) {
            ...
            public void onClick(View v) {
                if (brance.is_selected){
                    ...
                    Toast.makeText (context, "Deselected "+brance.getStorename (), Toast.LENGTH_SHORT).show ( );
                }else {
                    brance.is_selected=true;
                    holder.binding.lin.setBackgroundColor (context.getResources ().getColor (R.color.teal_700));
                    Toast.makeText (context, "Selected "+brance.getStorename (), Toast.LENGTH_SHORT).show ( );
                }
