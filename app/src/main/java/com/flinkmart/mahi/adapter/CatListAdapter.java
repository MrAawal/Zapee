...
import com.flinkmart.mahi.model.SingleSelection;
...
public class CatListAdapter extends RecyclerView.Adapter<CatListAdapter.holder> {
    ...
    FilterAdapter2 categoryListAdapter;
    ...
    public CatListAdapter(Context context, List<Catlist> categoryItems, RecyclerView recyclerView1, FilterAdapter2 categoryListAdapter, ArrayList<Item> itemList, TextView quantity, CardView layout) {
...
//            holder.binding.label.setBackgroundResource (R.drawable.product);
