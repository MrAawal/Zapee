...
public class Constants {
    public static String API_BASE_URL = "https://flink-mart.com/android";
    ...
    public static String GET_PRODUCTS_URL1 = API_BASE_URL + "/services/listProduct";
    ...
    public static String GET_BANNERS_URL = API_BASE_URL + "/android/banners/read.php";
