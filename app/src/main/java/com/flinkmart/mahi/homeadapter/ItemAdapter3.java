...
import com.flinkmart.mahi.homemodel.Item3;

import java.util.List;

public class ItemAdapter3 extends RecyclerView.Adapter<ItemAdapter3.holder>{

    Context context;
    List<Item3> productItems;

    public ItemAdapter3(Context context, List<Item3> productItems) {
    ...
    @NonNull
    @Override
    public ItemAdapter3.holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
       View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.newitem_product, parent , false);
       return  new holder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ItemAdapter3.holder holder, int position) {
        Item3 newProductModel=productItems.get (position);
...
//        });
    ...
    public void addProduct(Item3 newProductModel) {
