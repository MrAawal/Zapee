...
public class ItemAdapter4 extends RecyclerView.Adapter<ItemAdapter4.holder>{

    Context context;
    List<Item4> productItems;

    public ItemAdapter4(Context context, List<Item4> productItems) {
    ...
    @NonNull
    @Override
    public ItemAdapter4.holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
       View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.newitem_product, parent , false);
       return  new holder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ItemAdapter4.holder holder, int position) {
