...
public class BestSellerModel implements com.hishd.tinycart.model.Item {
    ...
    public BestSellerModel(String tittle, String image, String id, String price, String discount, String stock, String description, String category, String subcategory, String branch) {
        this.tittle = tittle;
        this.image = image;
        this.id = id;
        this.price = price;
