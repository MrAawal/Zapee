...
import com.flinkmart.mahi.activities.dashboardActivity;
...
public class RestuarantAdapter extends RecyclerView.Adapter<RestuarantAdapter.branchViewholder> {
    ...
    List<Resturant> branchemodel;

    List<Resturant> modelListFilter;
    ...
    public void addProduct(Resturant branch){
    ...
    public void onBindViewHolder(@NonNull branchViewholder holder, int position) {
        Resturant brance=branchemodel.get (position);
        ...
        return new Filter(){
            ...
            protected FilterResults performFiltering(CharSequence constraint) {
                ...
                if (charcater.isEmpty()){
                    ...
                    List<Resturant> filterList = new ArrayList<>();
                    for (Resturant row: branchemodel){
            ...
            protected void publishResults(CharSequence constraint, FilterResults results) {
                modelListFilter = (ArrayList<Resturant>) results.values ;
                notifyDataSetChanged();
            }
        };
    }
