...
public class StoreHomeProductAdapter extends RecyclerView.Adapter<StoreHomeProductAdapter.MyHolder> implements Filterable {
    ...
    public StoreHomeProductAdapter(Context context, List<Item> modelList, TextView quantity, CardView layout) {
    ...
    @Override
    public void onBindViewHolder(@NonNull StoreHomeProductAdapter.MyHolder holder, int position) {
