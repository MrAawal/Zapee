...
import com.flinkmart.mahi.storeadapter.StoreCategoryAdapter;
import com.flinkmart.mahi.storemodel.StoreSubCategoryListModel;
...
public class RestuarantActivity extends AppCompatActivity {
    ...
    StoreHomeProductAdapter filterAdapter2;
    StoreCategoryAdapter catlistAdapter;
    StoreSubCategoryAdapter subcatList;
    List<Catlist> catlists = new ArrayList<>();
    List<StoreSubCategoryListModel>subCatlistModels=new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        catlistAdapter = new StoreCategoryAdapter (this, catlists);
        binding.branchList.setAdapter (catlistAdapter);
        binding.branchList.setLayoutManager (new GridLayoutManager (this,4));
        filterAdapter2 = new StoreHomeProductAdapter (this, item1s,quantity,layout);
